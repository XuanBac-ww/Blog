package com.example.BlogBe.security.jwt;

import com.example.BlogBe.security.user.BlogUserDetails;
...
public class JwtUtils {
    ...
    public String generateAccessTokenForUser(Authentication authentication) {
        BlogUserDetails userPrincipal = (BlogUserDetails) authentication.getPrincipal();
